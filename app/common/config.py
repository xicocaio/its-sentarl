...
class Config:
    def __init__(self,
        ...
        self._reward_function = reward_function if self.stg not in settings.STGS_BASE else settings.REWARD_FUNCTIONS[0]
        ...
        self._deterministic_test = True if self.setup == 'rolling' else deterministic_test
