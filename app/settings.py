...
RESULTS_HEADER = ['window_step', 'current_step', 'date', 'asset', 'company_name', 'frequency', 'initial_wealth', 'tc', 'stg', 'algo',
                  'action_type', 'reward_type', 'seed', 'train_episodes', 'action_value', 'total_return', 'reward',
                  'total_reward',
                  'total_profit']
